...
function RegisterPage() {
  return (
    <div className="h-full min-h-screen overflow-hidden relative flex flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
      <BgShapeTop
        colorFrom="from-[#e11d48] dark:from-[#4f46e5]"
        colorTo="to-[#f97316] dark:to-[#8e43e7]"
      />
      <Header />
      <div className="flex flex-col mt-20 md:mt-10 items-center sm:mx-auto sm:w-full sm:max-w-md">
