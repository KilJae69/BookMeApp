          ...
          <div className="relative">
            <Listbox.Button
              className={classNames(
                ...
                "relative inline-flex items-center whitespace-nowrap rounded-full group transition-colors px-2 py-2 text-sm font-medium text-textPrimary500 sm:px-3"
              )}
            >
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute right-0 z-10 mt-1 max-h-56 w-52 overflow-auto rounded-lg bg-secondaryBg dark:bg-secondaryBgDark py-3 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                {colors.map((color) => (
                  <Listbox.Option
                    key={color.value}
                    className={({ active }) =>
